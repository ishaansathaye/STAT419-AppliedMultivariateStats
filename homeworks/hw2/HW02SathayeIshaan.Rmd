...
calcium_data <- read.table(file="T3_3_Calcium.DAT", sep="")
calcium_data
...
```{r}
stars(calcium_data[,2:4], labels=calcium_data$location, key.loc=c(6, 1.8))
```
...
```{r}
setwd(dirname(rstudioapi::getActiveDocumentContext()$path))
probes <- read.table(file="T3_5_Probe.DAT", sep="")
probes
